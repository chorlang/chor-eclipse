...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Global Type Interaction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.chor.chor.impl.GlobalTypeInteractionImpl#getSender <em>Sender</em>}</li>
 *   <li>{@link org.chor.chor.impl.GlobalTypeInteractionImpl#getReceiver <em>Receiver</em>}</li>
 *   <li>{@link org.chor.chor.impl.GlobalTypeInteractionImpl#getBranches <em>Branches</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalTypeInteractionImpl extends GlobalTypeImpl implements GlobalTypeInteraction
{
  /**
   ...
   * @generated
   */
  protected GlobalTypeInteractionImpl()
  {
    super();
  }
  ...
  {
    return ChorPackage.Literals.GLOBAL_TYPE_INTERACTION;
  }
  ...
  public void setSender(String newSender)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChorPackage.GLOBAL_TYPE_INTERACTION__SENDER, oldSender, sender));
  }
  ...
  public void setReceiver(String newReceiver)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChorPackage.GLOBAL_TYPE_INTERACTION__RECEIVER, oldReceiver, receiver));
  }
  ...
  public EList<BranchGType> getBranches()
  {
    if (branches == null)
    {
      branches = new EObjectContainmentEList<BranchGType>(BranchGType.class, this, ChorPackage.GLOBAL_TYPE_INTERACTION__BRANCHES);
    }
    return branches;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ChorPackage.GLOBAL_TYPE_INTERACTION__BRANCHES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ChorPackage.GLOBAL_TYPE_INTERACTION__SENDER:
        return getSender();
      case ChorPackage.GLOBAL_TYPE_INTERACTION__RECEIVER:
        return getReceiver();
      case ChorPackage.GLOBAL_TYPE_INTERACTION__BRANCHES:
        return getBranches();
    }
